  ...
  return (
    ...
    >
      ...
      <div className="relative h-full bg-white/90 dark:bg-slate-900/90 backdrop-blur-xl p-4 rounded-xl flex flex-col items-center text-center z-10">
        <img
          alt={`${name} logo`}
          className="h-10 w-10 mb-3 drop-shadow-lg"
          src={icon}
        />
...
const Skills = () => {
  ...
  const backendSkills = [
    ...
    },
    {
      name: "REST API",
      percentage: 80,
      icon: "https://img.icons8.com/external-flaticons-flat-flat-icons/64/external-api-web-development-flaticons-flat-flat-icons.png",
    },
  ];
      ...
      <div className=" mx-auto py-12 sm:pt-16 sm:pb-10">
        ...
        <div className="space-y-5">
          {[
            ...
            <div
              key={idx}
              className=" p-0 md:p-6 rounded-lg transition-shadow duration-300 flex flex-col  text-center"
            >
              <motion.div
